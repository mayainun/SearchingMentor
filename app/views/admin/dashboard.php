  ...
  <script>
        function confirmLogout(event) {
            ...
            if (confirm("Apakah anda yakin ingin logout?")) {
                window.location.href = "?controller=Admin&method=loginPage"; // Redirect to Home.php if confirmed
            } else {
                // Do nothing if "Tidak" is clicked
            }
        }
    </script>
</head>
    ...
    <div class="relative flex-1 flex flex-col min-h-0 border-r border-gray-200 bg-white pt-0">
        ...
        <div class="flex-1 px-3 bg-white divide-y space-y-1">
            ...
            <div class="space-y-2 pt-2">
                <form method="POST" action="?controller=Admin&method=logoutAdmin" onsubmit="confirmLogout(event)">
                    <button type="submit" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 group transition duration-75 flex items-center p-2">
